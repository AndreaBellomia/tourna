const profile = {
  ...
  form: {
    ...
    emailVerifiedDescription: 'Questo indirizzo email e verificato.',
    resendVerification: 'Rimanda email di verifica',
    verificationSent: 'Email di verifica inviata.',
    verificationFailed: 'Invio email di verifica non riuscito.',
    avatar: 'Avatar',
