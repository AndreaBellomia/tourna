...
var init_digest = __esm({
  "../../node_modules/.pnpm/jose@5.10.0/node_modules/jose/dist/node/esm/runtime/digest.js"() {
    init_esm();
    digest = /* @__PURE__ */ __name((algorithm, data) => createHash(algorithm).update(data).digest(), "digest");
...
var init_base64url = __esm({
  "../../node_modules/.pnpm/jose@5.10.0/node_modules/jose/dist/node/esm/runtime/base64url.js"() {
    ...
    encode = /* @__PURE__ */ __name((input) => Buffer2.from(input).toString("base64url"), "encode");
    decode = /* @__PURE__ */ __name((input) => new Uint8Array(Buffer2.from(normalize(input), "base64url")), "decode");
  }
});
...
var init_iv = __esm({
  "../../node_modules/.pnpm/jose@5.10.0/node_modules/jose/dist/node/esm/lib/iv.js"() {
    ...
    iv_default = /* @__PURE__ */ __name((alg) => randomFillSync(new Uint8Array(bitLength(alg) >> 3)), "default");
  }
});
...
var init_is_key_object = __esm({
  "../../node_modules/.pnpm/jose@5.10.0/node_modules/jose/dist/node/esm/runtime/is_key_object.js"() {
    init_esm();
    is_key_object_default = /* @__PURE__ */ __name((obj) => util.types.isKeyObject(obj), "default");
  }
});
...
var init_check_cek_length = __esm({
  "../../node_modules/.pnpm/jose@5.10.0/node_modules/jose/dist/node/esm/runtime/check_cek_length.js"() {
    ...
    init_errors();
    init_is_key_object();
    checkCekLength = /* @__PURE__ */ __name((enc, cek) => {
      let expected;
      switch (enc) {
        case "A128CBC-HS256":
        case "A192CBC-HS384":
...
var init_webcrypto = __esm({
  "../../node_modules/.pnpm/jose@5.10.0/node_modules/jose/dist/node/esm/runtime/webcrypto.js"() {
    ...
    isCryptoKey = /* @__PURE__ */ __name((key) => util2.types.isCryptoKey(key), "isCryptoKey");
  }
});
...
var ciphers, ciphers_default;
var init_ciphers = __esm({
  "../../node_modules/.pnpm/jose@5.10.0/node_modules/jose/dist/node/esm/runtime/ciphers.js"() {
    init_esm();
    ciphers_default = /* @__PURE__ */ __name((algorithm) => {
...
var init_is_key_like = __esm({
  "../../node_modules/.pnpm/jose@5.10.0/node_modules/jose/dist/node/esm/runtime/is_key_like.js"() {
    ...
    init_webcrypto();
    init_is_key_object();
    is_key_like_default = /* @__PURE__ */ __name((key) => is_key_object_default(key) || isCryptoKey(key), "default");
    types3 = ["KeyObject"];
...
var init_decrypt = __esm({
  "../../node_modules/.pnpm/jose@5.10.0/node_modules/jose/dist/node/esm/runtime/decrypt.js"() {
    ...
    decrypt = /* @__PURE__ */ __name((enc, cek, ciphertext, iv, tag2, aad) => {
      let key;
      if (isCryptoKey(cek)) {
...
var init_aeskw = __esm({
  "../../node_modules/.pnpm/jose@5.10.0/node_modules/jose/dist/node/esm/runtime/aeskw.js"() {
    ...
    wrap = /* @__PURE__ */ __name((alg, key, cek) => {
    ...
    unwrap = /* @__PURE__ */ __name((alg, key, encryptedKey) => {
      const size = parseInt(alg.slice(1, 4), 10);
      const algorithm = `aes${size}-wrap`;
      if (!ciphers_default(algorithm)) {
        throw new JOSENotSupported(`alg ${alg} is not supported either by JOSE or your javascript runtime`);
...
var init_get_named_curve = __esm({
  "../../node_modules/.pnpm/jose@5.10.0/node_modules/jose/dist/node/esm/runtime/get_named_curve.js"() {
    ...
    init_is_key_like();
    init_is_jwk();
    namedCurveToJOSE = /* @__PURE__ */ __name((namedCurve) => {
      switch (namedCurve) {
        case "prime256v1":
          return "P-256";
        case "secp384r1":
    ...
    getNamedCurve2 = /* @__PURE__ */ __name((kee, raw) => {
      let key;
      if (isCryptoKey(kee)) {
...
var generateKeyPair, ecdhAllowed;
var init_ecdhes = __esm({
  "../../node_modules/.pnpm/jose@5.10.0/node_modules/jose/dist/node/esm/runtime/ecdhes.js"() {
    ...
    init_invalid_key_input();
    init_is_key_like();
    generateKeyPair = promisify(generateKeyPairCb);
    __name(deriveKey, "deriveKey");
    __name(generateEpk, "generateEpk");
    ecdhAllowed = /* @__PURE__ */ __name((key) => ["P-256", "P-384", "P-521", "X25519", "X448"].includes(get_named_curve_default(key)), "ecdhAllowed");
  }
});
...
var init_pbes2kw = __esm({
  "../../node_modules/.pnpm/jose@5.10.0/node_modules/jose/dist/node/esm/runtime/pbes2kw.js"() {
    ...
    init_invalid_key_input();
    init_is_key_like();
    pbkdf2 = promisify2(pbkdf2cb);
    __name(getPassword, "getPassword");
    encrypt = /* @__PURE__ */ __name(async (alg, key, cek, p2c = 2048, p2s2 = randomFillSync(new Uint8Array(16))) => {
      checkP2s(p2s2);
...
var init_check_key_length = __esm({
  "../../node_modules/.pnpm/jose@5.10.0/node_modules/jose/dist/node/esm/runtime/check_key_length.js"() {
    init_esm();
    check_key_length_default = /* @__PURE__ */ __name((key, alg) => {
      let modulusLength;
      try {
...
var checkKey, RSA1_5, resolvePadding, resolveOaepHash, encrypt2, decrypt3;
var init_rsaes = __esm({
  "../../node_modules/.pnpm/jose@5.10.0/node_modules/jose/dist/node/esm/runtime/rsaes.js"() {
    ...
    init_invalid_key_input();
    init_is_key_like();
    checkKey = /* @__PURE__ */ __name((key, alg) => {
      if (key.asymmetricKeyType !== "rsa") {
        throw new TypeError("Invalid key for this operation, its asymmetricKeyType must be rsa");
      }
      check_key_length_default(key, alg);
    }, "checkKey");
    RSA1_5 = deprecate(() => constants.RSA_PKCS1_PADDING, 'The RSA1_5 "alg" (JWE Algorithm) is deprecated and will be removed in the next major revision.');
    resolvePadding = /* @__PURE__ */ __name((alg) => {
      switch (alg) {
        case "RSA-OAEP":
        case "RSA-OAEP-256":
        case "RSA-OAEP-384":
    ...
    resolveOaepHash = /* @__PURE__ */ __name((alg) => {
      switch (alg) {
        case "RSA-OAEP":
          return "sha1";
        case "RSA-OAEP-256":
    ...
    encrypt2 = /* @__PURE__ */ __name((alg, key, cek) => {
    ...
    decrypt3 = /* @__PURE__ */ __name((alg, key, encryptedKey) => {
      const padding = resolvePadding(alg);
      const oaepHash = resolveOaepHash(alg);
...
var init_cek = __esm({
  "../../node_modules/.pnpm/jose@5.10.0/node_modules/jose/dist/node/esm/lib/cek.js"() {
    ...
    cek_default = /* @__PURE__ */ __name((alg) => randomFillSync(new Uint8Array(bitLength2(alg) >> 3)), "default");
  }
});
...
var genericExport, toSPKI, toPKCS8, fromPKCS8, fromSPKI, fromX509;
var init_asn1 = __esm({
  "../../node_modules/.pnpm/jose@5.10.0/node_modules/jose/dist/node/esm/runtime/asn1.js"() {
    init_esm();
    init_webcrypto();
    ...
    init_invalid_key_input();
    init_is_key_like();
    genericExport = /* @__PURE__ */ __name((keyType, keyFormat, key) => {
      let keyObject;
      if (isCryptoKey(key)) {
        if (!key.extractable) {
    ...
    fromPKCS8 = /* @__PURE__ */ __name((pem) => createPrivateKey({
      key: Buffer4.from(pem.replace(/(?:-----(?:BEGIN|END) PRIVATE KEY-----|\s)/g, ""), "base64"),
      type: "pkcs8",
      format: "der"
    }), "fromPKCS8");
    fromSPKI = /* @__PURE__ */ __name((pem) => createPublicKey({
      key: Buffer4.from(pem.replace(/(?:-----(?:BEGIN|END) PUBLIC KEY-----|\s)/g, ""), "base64"),
      type: "spki",
      format: "der"
    }), "fromSPKI");
    fromX509 = /* @__PURE__ */ __name((pem) => createPublicKey({
      key: pem,
      type: "spki",
      format: "pem"
    }), "fromX509");
...
var init_encrypt = __esm({
  "../../node_modules/.pnpm/jose@5.10.0/node_modules/jose/dist/node/esm/runtime/encrypt.js"() {
    ...
    encrypt3 = /* @__PURE__ */ __name((enc, plaintext, cek, iv, aad) => {
      let key;
      if (isCryptoKey(cek)) {
...
var init_sign = __esm({
  "../../node_modules/.pnpm/jose@5.10.0/node_modules/jose/dist/node/esm/runtime/sign.js"() {
    ...
    oneShotSign = promisify3(crypto2.sign);
...
var init_verify = __esm({
  "../../node_modules/.pnpm/jose@5.10.0/node_modules/jose/dist/node/esm/runtime/verify.js"() {
    ...
    init_sign();
    init_get_sign_verify_key();
    oneShotVerify = promisify4(crypto3.verify);
...
var init_generate = __esm({
  "../../node_modules/.pnpm/jose@5.10.0/node_modules/jose/dist/node/esm/runtime/generate.js"() {
    ...
    init_random();
    init_errors();
    generate = promisify5(generateKeyPairCb2);
...
//# sourceMappingURL=esm-U2OMRNYP.mjs.map
